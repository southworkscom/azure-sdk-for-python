...
class BotConnectorConfiguration(Configuration):
    ...
    def __init__(
        ...
        self.add_user_agent('azure-botframework-connector/{}'.format(VERSION))
...
class BotConnector(object):
    ...
    * Generate your own from the [Connector API Swagger file](https://raw.githubusercontent.com/Microsoft/BotBuilder/master/CSharp/Library/Microsoft.Bot.Connector.Shared/Swagger/ConnectorAPI.json)
    ...
    :vartype attachments: azure.botframework.connector.operations.AttachmentsOperations
    :ivar conversations: Conversations operations
    :vartype conversations: azure.botframework.connector.operations.ConversationsOperations
