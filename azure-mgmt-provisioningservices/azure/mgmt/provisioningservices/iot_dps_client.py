...
class IotDpsClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('azure-mgmt-provisioningservices/{}'.format(VERSION))
...
class IotDpsClient(object):
    ...
    :vartype operations: azure.mgmt.provisioningservices.operations.Operations
    :ivar dps_certificate: DpsCertificate operations
    :vartype dps_certificate: azure.mgmt.provisioningservices.operations.DpsCertificateOperations
    :ivar iot_dps_resource: IotDpsResource operations
    :vartype iot_dps_resource: azure.mgmt.provisioningservices.operations.IotDpsResourceOperations
    :ivar dps_certificates: DpsCertificates operations
    :vartype dps_certificates: azure.mgmt.provisioningservices.operations.DpsCertificatesOperations
