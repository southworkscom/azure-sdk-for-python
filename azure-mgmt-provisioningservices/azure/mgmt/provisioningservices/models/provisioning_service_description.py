...
class ProvisioningServiceDescription(Resource):
    ...
    :type properties:
     ~azure.mgmt.provisioningservices.models.IotDpsPropertiesDescription
    :param sku: Sku info for a provisioning Service.
    :type sku: ~azure.mgmt.provisioningservices.models.IotDpsSkuInfo
    """
    ...
    def __init__(self, location, properties, sku, tags=None, etag=None):
        super(ProvisioningServiceDescription, self).__init__(location=location, tags=tags)
        self.etag = etag
