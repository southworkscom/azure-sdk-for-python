...
class IotDpsPropertiesDescription(Model):
    ...
    :type state: str or ~azure.mgmt.provisioningservices.models.State
    ...
    :param iot_hubs: List of IoT hubs assosciated with this provisioning
     service.
    :type iot_hubs:
     list[~azure.mgmt.provisioningservices.models.IotHubDefinitionDescription]
    ...
    :type allocation_policy: str or
     ~azure.mgmt.provisioningservices.models.AllocationPolicy
    ...
    :type authorization_policies:
     list[~azure.mgmt.provisioningservices.models.SharedAccessSignatureAuthorizationRuleAccessRightsDescription]
    """
